...
# This script converts images and xml files into a format that TensorFlow accepts — TFRecord. 
...
# Now you’re ready to run the TFRecord script. Run the command below from the tensorflow/models/research directory, 
