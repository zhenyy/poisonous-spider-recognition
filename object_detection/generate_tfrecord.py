...
#         None
def class_text_to_int(row_label):
    if row_label == 'Garden Orb Weaver Spider':
        return 1
        ...
        return 4
    elif row_label == 'Daddy Long Legs Spider':
        return 5
    elif row_label == 'Huntsman Spider':
        return 6
    elif row_label == 'Red Headed Mouse Spider':
        return 7
    elif row_label == 'St Andrew\'s Cross Spider':
        return 8
